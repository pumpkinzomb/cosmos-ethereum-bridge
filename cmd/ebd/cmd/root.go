...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			customTemplate, customEthbridgeConfig := initAppConfig()
			return server.InterceptConfigsPreRunHandler(cmd, customTemplate, customEthbridgeConfig)
		},
	}
...
func (ac appCreator) appExport(
	...
	if height != -1 {
		if err := EthereumbridgeApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	}

	return EthereumbridgeApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
